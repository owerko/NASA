...
# LO print(base_temperatures.head(3))

plt.figure(figsize=(20, 10))
ax_lineplot = sns.lineplot(data=base_temperatures['Temperature'])
plt.show()

plt.figure(figsize=(10, 10))
plt.subplot(211)
base_temperatures['Temperature'].hist()
plt.subplot(212)
base_temperatures['Temperature'].plot(kind='kde')
plt.show()


def prepare_data_for_arima(dataset, training_size=0.6):
...
lst_day_train, lst_day_validation = prepare_data_for_arima(base_temperatures['Temperature'])
