...
# fig.savefig('fig1_t2.eps', format='eps', dpi=600)
...
# ax.savefig('fig2_t2.eps', format='eps', dpi=600)
plt.tight_layout()
...
# fig.savefig('fig3_t2.eps', format='eps', dpi=600)
plt.show()
...
# fig.savefig('fig4_t2.eps', format='eps', dpi=600)
plt.show()
