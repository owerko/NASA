...
ax_lineplot = sns.lineplot(data=base_temperatures['Humidity'])
plt.show()

plt.figure(figsize=(10, 10))
plt.subplot(211)
base_temperatures['Humidity'].hist()
plt.subplot(212)
base_temperatures['Humidity'].plot(kind='kde')
plt.show()
...
lst_day_train, lst_day_validation = prepare_data_for_arima(base_temperatures['Humidity'])
