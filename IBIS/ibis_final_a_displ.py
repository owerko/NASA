...
y = base_temperatures.loc[::4]['Displacement']
print(y)
...
# series_list_print_param_aci.to_csv('ibis_fin_param_aci_a_displ.csv', sep=';')
...
# Najmniejsze AIC
# ARIMA(1, 0, 0)x(0, 1, 1, 24)24 - AIC:770.9596684218552
