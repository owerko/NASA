...
y = base_temperatures.loc[::4]['Atm_pressure']
print(y)
...
# series_list_print_param_aci.to_csv('ibis_fin_param_aci_press.csv', sep=';')
...
# Najmniejsze AIC
# ARIMA(1, 1, 0)x(1, 0, 0, 24)24 - AIC:277.4217712345171
